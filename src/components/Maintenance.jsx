			...
			<Script
				...
				dangerouslySetInnerHTML={{
					__html: JSON.stringify({
						...
						description:
							'HorlaTechs delivers top-tier software engineering, web development, mobile app development, CRM solutions, and backend services.',
						address: {
							'@type': 'PostalAddress',
				...
				<div className='max-w-7xl mx-auto px-6 md:px-12 lg:px-20 flex flex-col-reverse md:flex-row items-center gap-12'>
					...
					<div className='flex-1 text-center md:text-left'>
						<h1 className='text-4xl md:text-5xl font-extrabold text-gray-800 leading-tight'>
							🚧 We’re Upgrading for a Better{' '}
							<span className='text-blue-600'>Digital Experience</span>
						</h1>
						<p className='mt-6 text-lg text-gray-700 max-w-xl mx-auto md:mx-0'>
							HorlaTechs is currently undergoing scheduled maintenance to bring
							you faster, smarter, and more reliable{' '}
							<strong>software solutions</strong>, including{' '}
							<strong>web development</strong>, <strong>mobile apps</strong>,
							<strong>CRM platforms</strong>, and{' '}
							<strong>backend services</strong>. Based in Lagos, Nigeria, we’re
							preparing to launch a new experience tailored for businesses
							worldwide.
						</p>
