...
import logo from '../../public/horlatechs_logo-rmbg.png';
...
const NavBar = () => {
	...
	return (
		<header className='flex justify-between md:justify-around items-center px-3 py-5 top-0 w-full fixed z-10 bg-white/50 backdrop-blur-md border-b border-white/20'>
			...
			<nav
				ref={menuRef}
				className={`fixed top-10 text-center w-full bg-white/95 z-20 shadow-md rounded-lg p-4 md:hidden transform transition-all duration-300 ${
					menuOpen
