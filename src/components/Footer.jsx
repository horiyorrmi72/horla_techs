			...
			<footer className='bg-black/90 text-white py-10 mt-10'>
				<div className='max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-5 gap-8'>
					<div className='md:col-span-2'>
						<h2 className='text-lg font-stretch-semi-condensed mb-3'>
							HorlaTechs
						</h2>
						<p className='text-sm '>
							...
							systems, and secure backend services. We deliver fast, scalable,
							and innovative digital solutions that help businesses locally and
							globally grow, automate, and thrive in the modern digital era.
						</p>
					</div>

					<div>
						<h3 className='font-stretch-semi-condensed mb-3'>Quick Links</h3>
					...
					<div>
						<h3 className='font-stretch-semi-condensed mb-3'>Services</h3>
						<ul className='space-y-2'>
							<li>
								<Link
